    ...
    <div
        ...
        <div class="container ">
            <div class="card p-3 mt-5 d-flex justify-content-center">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ url('invoice_submit') }}" enctype="multipart/form-data"
                        id="invoice_form">
                        @csrf

                        <div class="form-group mt-3">
                            <label for="qty">Qty</label>
                            <input oninput="total_cal()" type="number" class="form-control" id="qty"
                        ...
                        <div class="form-group mt-3">
                            ...
                            <input oninput="total_cal(); this.value = this.value.replace(/[^0-9]/g, '');" type="number"
                                class="form-control" id="amount" name="amount" placeholder="Enter Amount">
                            @error('amount')
                                <div class="error">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="form-group mt-3">
                            ...
                            <select onchange="cal_tax()" class="form-select" id="tax_percentage" name="tax_percentage">
                        ...
                        <div class="form-group mt-3">
                            ...
                            <input type="number" onchange="cal_netAmt()" class="form-control" id="tax_amount"
                                name="tax_amount" placeholder="">
                            @error('tax_amount')
                                <div class="error">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="form-group mt-3">
                            ...
                            <input oninput="this.value = this.value.replace(/[^a-zA-Z]/g, '');" type="text"
                                class="form-control" id="cust_name" name="cust_name" placeholder="Enter Name">
                            @error('cust_name')
                                <div class="error">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="form-group mt-3">
                            ...
                            <input class="form-control" type="text" id="datepicker" name="invoice_date">
                            @error('invoice_date')
                                <div class="error">{{ $message }}</div>
                            @enderror
                        </div>
